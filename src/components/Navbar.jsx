...
export default () => {
  ...
  const navigation = [
      { title: "Customers", path: "#", isDrapdown: true, navs: dropdownNavs },
      { title: "Careers", path: "#" },
      { title: "Guides", path: "#" },
      { title: "Partners", path: "#" },
  ]
            ...
            <div className="flex items-center space-x-8 py-3 px-4 max-w-screen-xl mx-auto md:px-8">
                ...
                <div className="nav-menu flex-1 flex items-center justify-between">
                                        ...
                                        <li key={idx}>
                                            {
                                                item.isDrapdown ? (
                                                    ...
                                                    <Link to={item.path} className="block text-gray-700 hover:text-indigo-600">
                                                        {item.title}
                                                    </Link>
                                                )
                                            }
                    ...
                    <div className="flex-1 flex items-center justify-end space-x-2 sm:space-x-6">
                        ...
                        <Link to="login" className="whitespace-nowrap block py-3 text-center text-gray-700 hover:text-indigo-600 border rounded-lg md:border-none flex-col items-center" style={{ lineHeight: "1" }}>
                          Log in
                        </Link>
                        <Link to="register" className="whitespace-nowrap py-3 px-4 font-medium text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow md:inline flex-col items-center" style={{ lineHeight: "1" }}>
                          Sign up
                        </Link>
                      </div>
